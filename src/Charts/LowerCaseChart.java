...
public class LowerCaseChart {
    public LowerCaseChart() {
        showChart();
    }
    ...
    private void showChart(){
        ...
        Color color = new Color(54, 60, 255);
        renderer.setSeriesPaint(0, color);
        plot.setRangeGridlinePaint(Color.black);
        ChartFrame chartFrm = new ChartFrame("LowerCase Characters Record", chart, true);
