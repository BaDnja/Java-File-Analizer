...
public class UpperCaseChart extends JFrame {
    public UpperCaseChart() {
        showChart();
    }
    ...
    private void showChart(){
        ...
        Color color = new Color(255, 22, 10);
        renderer.setSeriesPaint(0, color);
        plot.setRangeGridlinePaint(Color.black);
        ChartFrame chartFrm = new ChartFrame("UpperCase Characters Record", chart, true);
